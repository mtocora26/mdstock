            ...
            <div class="product-categories-widget widget-item">
              ...
              <ul class="category-tree list-unstyled mb-0">
                ...
                <li class="category-item">
                  <div class="d-flex justify-content-between align-items-center category-header collapsed" data-bs-toggle="collapse" data-bs-target="#categories-bebidas-subcategories" aria-expanded="false" aria-controls="categories-bebidas-subcategories">
                    <a href="javascript:void(0)" class="category-link">Bebidas</a>
                    <span class="category-toggle">
                      <i class="bi bi-chevron-down"></i>
                      <i class="bi bi-chevron-up"></i>
                    </span>
                  </div>
                  <ul id="categories-bebidas-subcategories" class="subcategory-list list-unstyled collapse ps-3 mt-2">
                    <li><a href="#" class="subcategory-link">Agua</a></li>
                    <li><a href="#" class="subcategory-link">Jugos</a></li>
                    <li><a href="#" class="subcategory-link">Refrescos</a></li>
                    <li><a href="#" class="subcategory-link">Energizantes</a></li>
                    <li><a href="#" class="subcategory-link">Cervezas</a></li>
                  </ul>
                </li>

                <!-- Despensa -->
                <li class="category-item">
                  <div class="d-flex justify-content-between align-items-center category-header collapsed" data-bs-toggle="collapse" data-bs-target="#categories-despensa-subcategories" aria-expanded="false" aria-controls="categories-despensa-subcategories">
                    <a href="javascript:void(0)" class="category-link">Despensa</a>
                    <span class="category-toggle">
                      <i class="bi bi-chevron-down"></i>
                      <i class="bi bi-chevron-up"></i>
                    </span>
                  </div>
                  <ul id="categories-despensa-subcategories" class="subcategory-list list-unstyled collapse ps-3 mt-2">
                    <li><a href="#" class="subcategory-link">Arroz</a></li>
                    <li><a href="#" class="subcategory-link">Aceite</a></li>
                    <li><a href="#" class="subcategory-link">Pastas</a></li>
                    <li><a href="#" class="subcategory-link">Enlatados</a></li>
                    <li><a href="#" class="subcategory-link">Harinas</a></li>
                  </ul>
                </li>

                <!-- Snacks -->
                <li class="category-item">
                  <div class="d-flex justify-content-between align-items-center category-header collapsed" data-bs-toggle="collapse" data-bs-target="#categories-snacks-subcategories" aria-expanded="false" aria-controls="categories-snacks-subcategories">
                    <a href="javascript:void(0)" class="category-link">Snacks</a>
                    <span class="category-toggle">
                      <i class="bi bi-chevron-down"></i>
                      <i class="bi bi-chevron-up"></i>
                    </span>
                  </div>
                  <ul id="categories-snacks-subcategories" class="subcategory-list list-unstyled collapse ps-3 mt-2">
                    <li><a href="#" class="subcategory-link">Chips</a></li>
                    <li><a href="#" class="subcategory-link">Galletas</a></li>
                    <li><a href="#" class="subcategory-link">Nueces</a></li>
                    <li><a href="#" class="subcategory-link">Palomitas</a></li>
                    <li><a href="#" class="subcategory-link">Tortillas de maíz</a></li>
                  </ul>
                </li>

                <!-- Dulcería -->
                <li class="category-item">
                  <div class="d-flex justify-content-between align-items-center category-header collapsed" data-bs-toggle="collapse" data-bs-target="#categories-dulceria-subcategories" aria-expanded="false" aria-controls="categories-dulceria-subcategories">
                    <a href="javascript:void(0)" class="category-link">Dulcería</a>
                    <span class="category-toggle">
                      <i class="bi bi-chevron-down"></i>
                      <i class="bi bi-chevron-up"></i>
                    </span>
                  </div>
                  <ul id="categories-dulceria-subcategories" class="subcategory-list list-unstyled collapse ps-3 mt-2">
                    <li><a href="#" class="subcategory-link">Chocolate</a></li>
                    <li><a href="#" class="subcategory-link">Gomitas</a></li>
                    <li><a href="#" class="subcategory-link">Paletas</a></li>
                    <li><a href="#" class="subcategory-link">Caramelos</a></li>
                    <li><a href="#" class="subcategory-link">Chicles</a></li>
                  </ul>
                </li>
              </ul>
